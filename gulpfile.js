...
gulp.task('sass', function(){
  ...
  .pipe(gulp.dest('css')) // destination for the compiler css files
...
//watch for changes to any files in scss folder  and its sub folders and with .scss extension , run the Sass task when a change in minified
  gulp.watch('scss/**/*.scss', gulp.series('sass'))
  // watch for change on any .html file and reload the browser on change
